    ...
    <div className='min-h-screen flex items-center justify-center bg-black text-white px-4'>
      <div className='w-full max-w-md border-2 p-8 border-white rounded-2xl shadow-lg bg-gray-900'>
        ...
        <form onSubmit={handleRegister} className='space-y-6'>
          ...
          <p className='text-sm text-center mt-1'>Already Have an Account ? <span onClick={()=>router.push("/login")} className='text-blue-400 hover:underline cursor-pointer'>login</span></p>
          <button className='w-full px-4 py-2 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-colors cursor-pointer'>Register</button>
        </form>
